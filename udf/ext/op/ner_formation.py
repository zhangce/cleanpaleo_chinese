...
class FormationEntityExtractor:
	...
	def extract(self, doc):
		...
		## Larger dictionary ### TODO clean up plural
		## TODO: ABBRV FM, MBR, GRP 
		...
		"conglomerate":1, "chert":1, "coal":1, "breccia":1, "silt":1, "sand":1, "claystone":1, "clay":1, "arkose":1, "evaporite":1,
		"anhydrite":1, "gypsum":1, "mudstone":1, "marl":1, "argillite":1, "supergroup":1, "greensand":1, "grit":1, "flysch":1, "chalk":1, "oolite":1, "ash":1, "volcanics":1, "molasse":1, "schist":1, "phosphorite":1, "quartzite":1}
		...
		for sent in doc.sents:
			...
			for start in range(0, len(sent.words)):
				for end in reversed(range(start + 1, min(len(sent.words), start + 1 + MAXPHRASELEN))):
						...
						#rocktype = sent.words[end - 1].lower()
